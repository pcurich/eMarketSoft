...
{
    /// <summary>
    /// Parseador de los atributos de los clientes
    /// </summary>
    public partial class CustomerAttributeParser : ICustomerAttributeParser
    {
        ...
        /// <summary>
        /// Obteniene los identificadores de los atributos de un cliente seleccionados
        /// </summary>
        /// <param name="attributesXml">Attributos en formato XML</param>
        /// <returns>identificadores de clientes seleccionados</returns>
        protected virtual IList<int> ParseCustomerAttributeIds(string attributesXml)
        {
            ...
            try
            {
                ...
                var nodeList = xmlDoc.SelectNodes(@"//Attributes/CustomerAttribute");
                if (nodeList != null)
        ...
        /// <summary>
        /// Obteniene los atributos de un cliente seleccionados
        /// </summary>
        /// <param name="attributesXml">Attributos en formato XML</param>
        /// <returns>Atriubutos de clientes seleccionados</returns>
        ...
        /// <summary>
        /// Obteniene los valores de los atributos de un cliente seleccionados
        /// </summary>
        /// <param name="attributesXml">Attributos en formato XML</param>
        /// <returns>Valores de los atributos de clientes</returns>
