...
namespace Soft.Services.Catalog
{
    ...
    {
        /// <summary>
        /// Obtiene el precio especial de un producto
        /// </summary>
        /// <param name="product">Producto</param>
        /// <returns>Precio Especial; null si no tiene precio especial</returns>
        ...
        /// <summary>
        /// Obtiene una lista de cantidades (propiedades permitidas)
        /// </summary>
        /// <param name="product">Producto</param>
        /// <returns>arreglos de cantidades enteras</returns>
        ...
        /// <summary>
        /// Obtiene el total de las cantidaddes
        /// </summary>
        /// <param name="product">Producto</param>
        /// <param name="useReservedQuantity">
        /// Si se deberia considerar la propiedad de Cantidades Reservadas cuando multiples
        /// almacenes son utilizados
        /// </param>
        /// <param name="warehouseId">
        /// Identificador de almacen. Usado para delimitar un resultado en un almacen 
        /// especifico, solo cuando multiples almacenes son activados
        /// </param>
        /// <returns>Result</returns>
            ...
            bool useReservedQuantity = true, int warehouseId = 0)
        {
            ...
            if (product.ManageInventoryMethod != ManageInventoryMethod.ManageStock)
            {
                //No se puede calcular el total de la cantidad de stock cuando la gestion del inventatio esta seteada a Seguimiento de inventario
                return 0;
            }
