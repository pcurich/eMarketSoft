    ...
    public class ProductAttributeParser : IProductAttributeParser
    {
            ...
            string value)
        {
            ...
            try
            {
                ...
                if (String.IsNullOrEmpty(attributesXml))
                {
                    //Primer elemento que se crea como root del xml
        ...
        public virtual bool AreProductAttributesEqual(string attributesXml1, string attributesXml2)
        {
            ...
            if (ParseProductAttributeMappingIds(attributesXml1).Count ==
                ParseProductAttributeMappingIds(attributesXml2).Count)
            {
            ...
            string attributesXml)
        {
            ...
            {
                var attributesEqual = AreProductAttributesEqual(combination.AttributesXml, attributesXml);
                if (attributesEqual)
                    return combination;
            }
            ...
            out string senderEmail, out string giftCardMessage)
        {
            ...
            try
            {
                ...
                var recipientNameElement =
                    (XmlElement) xmlDoc.SelectSingleNode(@"//Attributes/GiftCardInfo/RecipientName");
                var recipientEmailElement =
                    (XmlElement) xmlDoc.SelectSingleNode(@"//Attributes/GiftCardInfo/RecipientEmail");
