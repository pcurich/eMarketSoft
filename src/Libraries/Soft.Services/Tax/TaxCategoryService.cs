...
namespace Soft.Services.Tax
{
    ...
    public partial class TaxCategoryService : ITaxCategoryService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string TAXCATEGORIES_ALL_KEY = "Soft.taxcategory.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : tax category ID
        /// </remarks>
        private const string TAXCATEGORIES_BY_ID_KEY = "Soft.taxcategory.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string TAXCATEGORIES_PATTERN_KEY = "Soft.taxcategory.";
