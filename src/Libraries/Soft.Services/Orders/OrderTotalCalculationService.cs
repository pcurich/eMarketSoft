...
namespace Soft.Services.Orders
{
    ...
    public partial class OrderTotalCalculationService : IOrderTotalCalculationService
    {
            ...
            out decimal taxRate, out Discount appliedDiscount)
        {
            ...
            else
            {
                ...
                if (shippingRateComputationMethods == null || shippingRateComputationMethods.Count == 0)
                    throw new SoftException("Shipping rate computation method could not be loaded");
        ...
        public virtual int CalculateRewardPoints(Customer customer, decimal amount)
        {
            ...
            if (_rewardPointsSettings.PointsForPurchasesAmount <= decimal.Zero)
                return 0;
            ...
            var points = (int)Math.Truncate(amount / _rewardPointsSettings.PointsForPurchasesAmount * _rewardPointsSettings.PointsForPurchasesPoints);
            return points;
        }
