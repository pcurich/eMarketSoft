...
namespace Soft.Services.Installation
{
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallLocaleResources()
        {
            ...
            //save resources
            foreach (var filePath in System.IO.Directory.EnumerateFiles(_webHelper.MapPath("~/App_Data/Localization/"), "*.Softres.xml", SearchOption.TopDirectoryOnly))
            {
            ...
            settingService.SaveSetting(new CatalogSettings
                {
                    ...
                    PageShareCode = "<!-- AddThis Button BEGIN --><div class=\"addthis_toolbox addthis_default_style \"><a class=\"addthis_button_preferred_1\"></a><a class=\"addthis_button_preferred_2\"></a><a class=\"addthis_button_preferred_3\"></a><a class=\"addthis_button_preferred_4\"></a><a class=\"addthis_button_compact\"></a><a class=\"addthis_counter addthis_bubble_style\"></a></div><script type=\"text/javascript\" src=\"http://s7.addcom/js/250/addthis_widget.js#pubid=Softsolutions\"></script><!-- AddThis Button END -->",
            ...
            settingService.SaveSetting(new StoreInformationSettings
                {
                    ...
                    FacebookLink = "http://www.facebook.com/SoftCommerce",
                    TwitterLink = "https://twitter.com/SoftCommerce",
                    YoutubeLink = "http://www.youtube.com/user/SoftCommerce",
                    GooglePlusLink = "https://plus.google.com/+Softcommerce",
                });
            ...
            settingService.SaveSetting(new RewardPointsSettings
                {
                    ...
                    PointsForPurchasesAmount = 10,
                    PointsForPurchasesPoints = 1,
                    PointsForPurchasesAwarded = OrderStatus.Complete,
                    PointsForPurchasesCanceled = OrderStatus.Cancelled,
                                    ...
                                    new BlogPost
                                        {
                                             ...
                                             Tags = "e-commerce, SoftCommerce, sample tag, money",
                                    ...
                                    new NewsItem
                                        {
                                             AllowComments = true,
                                             Language = defaultLanguage,
                                             Title = "SoftCommerce new release!",
                                             Short = "SoftCommerce includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!<br /><br />SoftCommerce is a fully customizable shopping cart. It's stable and highly usable. From downloads to documentation, www.SoftCommerce.com offers a comprehensive base of information, resources, and support to the SoftCommerce community.",
                                             Full = "<p>SoftCommerce includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p><p>For full feature list go to <a href=\"http://www.SoftCommerce.com\">SoftCommerce.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                                             Published  = true,
                                             CreatedOnUtc = DateTime.UtcNow,
                                        },
                                    new NewsItem
                                        {
                                             ...
                                             Short = "The new SoftCommerce store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site, this will enable you to keep up to date with any new products.",
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                new ScheduleTask
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "Soft.Services.Messages.QueuedMessagesSendTask, Soft.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "Soft.Services.Common.KeepAliveTask, Soft.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "Soft.Services.Customers.DeleteGuestsTask, Soft.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "Soft.Services.Caching.ClearCacheTask, Soft.Services",
                    Enabled = false,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Soft.Services.Logging.ClearLogTask, Soft.Services",
                    Enabled = false,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    ...
                    Seconds = 900,
                    Type = "Soft.Services.Directory.UpdateExchangeRateTask, Soft.Services",
                    Enabled = true,
                    StopOnError = false,
                },
            };
