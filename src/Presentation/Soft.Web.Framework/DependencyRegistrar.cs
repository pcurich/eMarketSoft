...
using Soft.Services.Blogs;
using Soft.Services.Catalog;
using Soft.Services.Cms;
...
using Soft.Services.Topics;
using Soft.Services.Vendors;
using Soft.Web.Framework.Context;
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            if (dataProviderSettings != null && dataProviderSettings.IsValid())
            {
                ...
                builder.Register<IDbContext>(c => new SoftContext(dataProviderSettings.DataConnectionString)).InstancePerLifetimeScope();
            }
            else
            {
                builder.Register<IDbContext>(c => new SoftContext(dataSettingsManager.LoadSettings().DataConnectionString)).InstancePerLifetimeScope();
            }
            ...
            builder.RegisterType<ProductTagService>().As<IProductTagService>()
                .WithParameter(ResolvedParameter.ForNamed<ICacheManager>("soft_cache_static"))
                .InstancePerLifetimeScope();
